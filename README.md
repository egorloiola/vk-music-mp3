...
# В конце файла есть ссылка на мою видеоинструкцию

## Если у вас не установлен git, nvm, node js, FFmpeg 
...
## Запускаем 🚀
# Открываем терминал (cmd) в директории проекта
# Устанавливаем зависимости командой: npm ci
